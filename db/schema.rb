...
ActiveRecord::Schema.define(version: 20150422013647) do
  ...
  create_table "assets", force: :cascade do |t|
    ...
    t.float    "listens_per_week", limit: 24,       default: 0.0
  ...
  add_index "assets", ["user_id", "listens_per_week"], name: "index_assets_on_user_id_and_listens_per_week", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer  "pic_id",              limit: 4
    t.integer  "playlists_count",     limit: 4,     default: 0
